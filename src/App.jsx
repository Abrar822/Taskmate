    ...
    <>
      {
        ...
        <div className="deleteMsg">
          ...
          <div className="btns">
            <button onClick={handleDeleteConfirmation} className="deletionBtns">Yes</button>
            <button className="deletionBtns" onClick={handleDeleteCancellation}>No</button>
          </div>
        </div>
      }
      {
      ...
      <TaskList tasks={tasks} search={search} setTask={setTask} setMsg={setMsg} setInput={setInput} editId={editId} setEditId={setEditId} input={input} activeFilter={activeFilter} setDeleteMsg={setDeleteMsg} deleteMsg={deleteMsg} setDeleteId={setDeleteId}/>
    </>
  )
}
